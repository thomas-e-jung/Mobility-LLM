...
class CACSR(nn.Module):
    def __init__(self, config):
        ...
        # rnn layer
        self.spatial_encoder = LLMModel(model_path = "params/"+ self.model_class, model_class= self.model_class, loc_size = self.loc_size, learnable_param_size = self.learnable_param_size, device = self.device)
